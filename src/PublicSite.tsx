...
const CONTACT_EMAIL =
    import.meta.env.VITE_CONTACT_EMAIL ?? 'hello@bizsyncos.com';
const LOCAL_BACKEND_URL =
    import.meta.env.VITE_BACKEND_URL ?? 'http://127.0.0.1:9000';
const backendPath = (path: string) =>
    `${LOCAL_BACKEND_URL.replace(/\/$/, '')}${path}`;
...
function RouteHeroScene({ preview }: { preview: boolean }) {
    ...
    return (
        ...
        >
            ...
            <span
                className="route-hero-ring route-ring-one"
                aria-hidden="true"
            />
            <span
                className="route-hero-ring route-ring-two"
                aria-hidden="true"
            />
            <svg
                className="route-hero-links"
                viewBox="0 0 520 430"
                aria-hidden="true"
            >
            ...
            >
                <i />{' '}
                {preview ? 'Live workspace preview' : 'Operating system ready'}
            </motion.span>
        </motion.div>
    );
}
...
export function ScreenshotGallery() {
    return (
        <section
            id="screens"
            className="screenshot-gallery section-pad compact-gallery"
        >
            <div className="section-intro centered">
                ...
                <p>
                    Original BizSyncOS demo-workspace visuals. They illustrate
                    the product experience; they are not customer data or
                    third-party assets.
                </p>
            </div>
            <div className="screenshot-feature">
                <div className="screenshot-label">
                    ...
                    <div>
                        ...
                        <strong>
                            One focused view for revenue, work, and risks.
                        </strong>
                    </div>
            ...
            <div className="screenshot-pair">
                <article>
                    <div>
                        ...
                        <strong>
                            Grounded answers and human-approved next actions.
                        </strong>
                    </div>
                    <img
                ...
                <article>
                    <div>
                        ...
                        <strong>
                            Orders, inventory, fulfillment, and finance in
                            context.
                        </strong>
                    </div>
                    <img
        ...
        <main className="route-page os-product-page">
                ...
                <div className="os-product-container">
                    <div className="os-product-hero-grid">
                        ...
                        <div className="os-product-hero-copy">
                            <p className="eyebrow blue">
                                <Sparkles size={14} /> THE UNIFIED OPERATING
                                SYSTEM
                            </p>
                            <h1>
                                One unified platform for modern{' '}
                                <span>omnichannel retail & D2C.</span>
                            </h1>
                            <p>
                                Orchestrate multi-channel orders, real-time
                                warehouse stock locks, automated GST
                                e-invoicing, courier routing, and AI decision
                                intelligence in a single real-time platform.
                                Zero glue code, zero data silos.
                            </p>
                            ...
                            <div className="os-product-hero-trust">
                                <span>
                                    <CheckCircle2 size={15} /> 15+ Native
                                    Connectors
                                </span>
                                <span>
                                ...
                                <span>
                                    <ShieldCheck size={15} /> ISO 27001
                                    Certified
                                </span>
                                <span>
                                    <Building2 size={15} /> 100% Hosted in AWS
                                    Mumbai
                                </span>
                            </div>
                        </div>
                            ...
                            <div className="osp-telemetry-card">
                                ...
                                <div className="osp-telemetry-header">
                                    <div className="osp-telemetry-title">
                                        ...
                                        <strong>
                                            BIZSYNCOS OPERATIONS ENGINE
                                        </strong>
                                    </div>
                                    <span className="osp-telemetry-tag">
                                        LIVE STREAM · 14.2ms
                                    </span>
                                </div>
                                ...
                                <div className="osp-telemetry-metrics">
                                    <div className="osp-metric-box">
                                        ...
                                        <span className="osp-trend positive">
                                            +18.4% vs yest.
                                        </span>
                                    </div>
                                    <div className="osp-metric-box">
                                        ...
                                        <span className="osp-trend neutral">
                                            99.4% SLA
                                        </span>
                                    </div>
                                    <div className="osp-metric-box">
                                ...
                                <div className="osp-feed-header">
                                    <span>
                                        REAL-TIME MULTI-CHANNEL INGESTION
                                    </span>
                                </div>
                                ...
                                <div className="osp-feed-list">
                                    <div className="osp-feed-item">
                                        ...
                                        <span className="osp-feed-badge allocated">
                                            Allocated (Delhi DC)
                                        </span>
                                        <span className="osp-feed-time">
                                            Just now
                                        </span>
                                    </div>
                                    ...
                                    <div className="osp-feed-item">
                                        ...
                                        <span className="osp-feed-badge manifest">
                                            Manifest Printed
                                        </span>
                                        <span className="osp-feed-time">
                                            2m ago
                                    ...
                                    <div className="osp-feed-item">
                                        ...
                                        <span className="osp-feed-badge awb">
                                            AWB Assigned
                                        </span>
                                        <span className="osp-feed-time">
                                            5m ago
                                    ...
                                    <div className="osp-feed-item">
                                        ...
                                        <span className="osp-feed-badge prepaid">
                                            Prepaid Verified
                                        </span>
                                        <span className="osp-feed-time">
                                            8m ago
                ...
                <div className="os-product-container">
                    <div className="osp-brandwall-header">
                        <span className="osp-brandwall-tag">
                            TRUSTED BY 250+ HIGH-GROWTH D2C BRANDS &amp;
                            ENTERPRISE RETAILERS ACROSS INDIA
                        </span>
                    </div>
                ...
                <div className="os-product-container">
                    <div className="osp-scale-grid">
                        <div className="osp-scale-card">
                            ...
                            <div className="osp-scale-label">
                                GMV Orchestrated (FY 25–26)
                            </div>
                            <div className="osp-scale-sub">
                                Across 15+ Native Channels
                            </div>
                        </div>
                        <div className="osp-scale-card">
                            <div className="osp-scale-value">
                            ...
                            <div className="osp-scale-label">
                                Orders &amp; Shipments Synced
                            </div>
                            <div className="osp-scale-sub">
                                Zero Oversell Cancellations
                            </div>
                        </div>
                        <div className="osp-scale-card">
                            <div className="osp-scale-value">
                            ...
                            <div className="osp-scale-label">
                                Fulfillment Hubs &amp; Stores
                            </div>
                            <div className="osp-scale-sub">
                                Real-Time Stock Locks
                            </div>
                        </div>
                        <div className="osp-scale-card">
                            ...
                            <div className="osp-scale-label">
                                Ingestion Event Bridge
                            </div>
                            <div className="osp-scale-sub">
                                Sub-15ms Signed Webhooks
                            </div>
                        </div>
                        <div className="osp-scale-card">
                            <div className="osp-scale-value highlight">
            ...
            <section className="os-product-tabs-section">
                <div className="os-product-container">
                    <div className="os-product-section-header">
                        ...
                        <h2>
                            Five mission-critical engines. Zero fragmented
                            tools.
                        </h2>
                        <p>
                            Explore how each core capability of BizSyncOS works
                            together in real time without spreadsheets or
                    ...
                    <div className="os-module-showcase">
                        <div className="os-module-left">
                            <span className="os-module-badge">
                                {currentModule.badge}
                            </span>
                            ...
                            <div className="os-module-caps">
                                ...
                                <ul>
                                    {currentModule.capabilities.map(
                                        (cap, i) => (
                                            <li key={i}>
                                                <CheckCircle2
                                                    size={16}
                            ...
                            {activeTab === 'oms' && (
                                <div className="module-preview-panel">
                                    <div className="panel-title">
                                        ...
                                        <strong>
                                            Unified Multi-Channel Order Pipeline
                                        </strong>
                                    ...
                                    <div className="panel-order-table">
                                        ...
                                        <div className="table-row">
                                            ...
                                            <span className="channel shopify">
                                                Shopify Plus
                                            </span>
                                            <span>
                                                Nike Pegasus 40 (Size 9)
                                            </span>
                                        ...
                                        <div className="table-row">
                                            ...
                                            <span className="channel flipkart">
                                                Flipkart Smart
                                            </span>
                                            <span>Puma Running Tee (M)</span>
                                            <span>South Zone (Bengaluru)</span>
                                            <span className="status awb">
                                                AWB Generated
                                            </span>
                                        </div>
                                        <div className="table-row">
                                            <strong>#WA-1094</strong>
                                            <span className="channel whatsapp">
                                                WhatsApp Direct
                                            </span>
                                    ...
                                    <div className="panel-footer-stat">
                                        <span>
                                            ⚡ Sub-15ms Event Bridge across all
                                            4 channels
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="module-preview-panel">
                                    ...
                                    <div className="panel-wms-content">
                                        ...
                                        <div className="wms-alert-box">
                                            <ShieldCheck size={16} />
                                            <span>
                                                Safety Buffer Rule Active:
                                                Automatic stockout shielding
                                                prevents marketplace seller
                                                rating penalties.
                                            </span>
                                        </div>
                                    </div>
                            ...
                            {activeTab === 'logistics' && (
                                <div className="module-preview-panel">
                                    <div className="panel-title">
                                        <Truck size={18} />
                                        <strong>
                                            Intelligent Courier Rate Shopping &
                                            Allocation
                                        </strong>
                                        <span className="badge-live">
                                            SLA Optimized
                                    ...
                                    <div className="panel-carrier-content">
                                        <div className="carrier-cards">
                                            <div className="carrier-card selected">
                                                ...
                                                <span className="carrier-action">
                                                    Auto-Allocated by Rule
                                                    Engine
                                                </span>
                                            </div>
                                        ...
                                        <div className="ndr-pill">
                                            <Zap size={14} />
                                            <span>
                                                WhatsApp NDR Assistant:
                                                Automatic re-attempt
                                                verification resolved 42% of
                                                failed deliveries.
                                            </span>
                                        </div>
                                    </div>
                            ...
                            {activeTab === 'finance' && (
                                <div className="module-preview-panel">
                                    <div className="panel-title">
                                        ...
                                        <strong>
                                            Automated GST E-Invoicing & Tally
                                            Bridge
                                        </strong>
                                        <span className="badge-live">
                                            IRN Compliant
                                ...
                                <div className="module-preview-panel">
                                    ...
                                    <div className="panel-ai-chat">
                                        <div className="chat-msg user">
                                            <p>
                                                Which SKU has stockout risk
                                                before the Diwali festive
                                                weekend?
                                            </p>
                                        </div>
                                        <div className="chat-msg bot">
                                            ...
                                            <p>
                                                ...
                                                is selling at{' '}
                                                <strong>42 units/day</strong>.
                                                At current velocity, Delhi Hub
                                                will deplete in{' '}
                                            ...
                                            <div className="bot-action-box">
                                                ...
                                                <span>
                                                    Transfer 80 units from
                                                    Mumbai DC (excess stock) to
                                                    Delhi Hub.
                                                </span>
                                                <button
                                                    type="button"
            ...
            <section className="os-product-pipeline-section">
                <div className="os-product-container">
                    <div className="os-product-section-header">
                        ...
                        <p>
                            From the initial storefront order to physical
                            dispatch, GST invoice generation, and bank ledger
                            reconciliation.
                        </p>
                    </div>
                    ...
                    <div className="os-pipeline-grid">
                        <div className="os-pipeline-card">
                            ...
                            <p>
                                Orders arrive via sub-15ms signed webhooks from
                                Shopify, Amazon SP-API, Flipkart, and WhatsApp.
                            </p>
                        ...
                        <div className="os-pipeline-card">
                            ...
                            <p>
                                AI verifies address deliverability, flags RTO
                                risk, and atomically locks inventory across all
                                sales channels.
                            </p>
                        ...
                        <div className="os-pipeline-card">
                            ...
                            <p>
                                Warehouse generates batch pick slips while
                                rate-shopping engine assigns the best courier
                                SLA and prints AWBs.
                            </p>
                        ...
                        <div className="os-pipeline-card">
                            ...
                            <p>
                                Instant IRN-compliant GST e-invoices are minted
                                and 2-way synced into Tally Prime or Zoho Books.
                            </p>
            ...
            <section className="os-product-roi-section">
                <div className="os-product-container">
                    <div className="os-product-section-header">
                        ...
                        <h2>
                            Tested by high-velocity commerce operations across
                            India.
                        </h2>
                    </div>
                    ...
                    <div className="os-product-metrics-grid">
                        <div className="os-metric-card">
                            ...
                            <p>
                                Pre-dispatch COD address verification & WhatsApp
                                payment recovery prevent fraudulent returns.
                            </p>
                        </div>
                        <div className="os-metric-card">
                            <strong>0%</strong>
                            ...
                            <p>
                                Sub-15ms multi-warehouse stock reservation
                                guarantees buffer safety on Amazon and Flipkart.
                            </p>
                        </div>
                        <div className="os-metric-card">
                            ...
                            <p>
                                Automated IRN GST generation and bi-directional
                                Tally sync eliminate duplicate data entry.
                            </p>
                        </div>
                        <div className="os-metric-card">
                            ...
                            <p>
                                1-Click OAuth connectors instantly import SKUs,
                                variants, prices, and stock balances.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="osp-case-studies-section">
                <div className="os-product-container">
                    <div className="os-product-section-header">
                        <p className="eyebrow blue">
                            <MessageSquareText size={15} /> VERIFIED CUSTOMER
                            CASE STUDIES
                        </p>
                        <h2>
                            How India's top D2C and omnichannel leaders scale on
                            BizSyncOS.
                        </h2>
                        <p>
                            Real operations executives, verified business
                            metrics, and zero promotional fluff.
                        </p>
                    </div>
                    ...
                    <div className="osp-case-cards-grid">
                        ...
                        <div className="osp-case-card">
                            <div className="osp-case-top">
                                <span className="osp-case-brand-tag snitch">
                                    SNITCH · FAST FASHION D2C
                                </span>
                            ...
                            <div className="osp-case-highlight-metric">
                                <strong>+340%</strong>
                                <span>
                                    Festive Peak Orders Handled · Zero
                                    Out-of-Stock Penalties
                                </span>
                            </div>

                            <p className="osp-case-quote">
                                “During the Diwali peak sale, we scaled from
                                3,000 to 22,000 orders/day across Shopify and
                                marketplaces. BizSyncOS locked inventory across
                                4 regional warehouses in under 12ms — saving us
                                over ₹18 Lakhs in potential marketplace
                            ...
                            <div className="osp-case-footer">
                                ...
                                <div className="osp-author-meta">
                                    ...
                                    <small>
                                        Bangalore, Karnataka · 4 Regional Hubs
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="osp-case-card">
                            ...
                            <div className="osp-case-highlight-metric">
                                ...
                                <span>
                                    Saved Every Month · 100% Automated GST &amp;
                                    Tally Prime Sync
                                </span>
                            </div>

                            <p className="osp-case-quote">
                                “Managing high-velocity fulfillment across
                                Amazon FBA, Quick Commerce dark stores, and our
                                direct portal was an accounting nightmare.
                                BizSyncOS automated our GST IRN generation and
                                two-way Tally Prime sync in real time with zero
                            ...
                            <div className="osp-case-footer">
                                ...
                                <div className="osp-author-meta">
                                    ...
                                    <small>
                                        Jaipur &amp; Bengaluru · 6 Dark Stores
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="osp-case-card">
                            ...
                            <div className="osp-case-highlight-metric">
                                ...
                                <span>
                                    In COD RTO Rate · ₹6.20 Saved per Shipment
                                </span>
                            </div>

                            <p className="osp-case-quote">
                                “Pre-dispatch COD address normalization and
                                automated WhatsApp confirmation dropped our
                                return-to-origin rate from 29% to 17% in 60
                                days. The automated rate-shopping engine across
                                Delhivery and Bluedart slashed our overall
                                shipping overhead.”
                            </p>
                            ...
                            <div className="osp-case-footer">
                                ...
                                <div className="osp-author-meta">
                                    ...
                                    <small>
                                        Mumbai, Maharashtra · 85 Retail Stores
                                    </small>
                                </div>
                            </div>
                        </div>
            ...
            <section className="osp-compliance-section">
                <div className="os-product-container">
                    <div className="os-product-section-header">
                        ...
                        <h2>
                            Bank-grade encryption. Governed for high-stakes
                            Indian commerce.
                        </h2>
                        <p>
                            Audited security infrastructure, official statutory
                            integrations, and 100% Indian data residency.
                        </p>
                    </div>
                    ...
                    <div className="osp-compliance-grid">
                        <div className="osp-compliance-card">
                            ...
                            <p>
                                ...
                                Certificate #ISMS-IN-2024-8842 audited by BSI
                                India.
                            </p>
                            <span className="comp-detail">
                                256-Bit AES Encryption · Key Rotation
                            </span>
                        </div>
                        ...
                        <div className="osp-compliance-card">
                            ...
                            <h4>SOC 2 Type II</h4>
                            <p>
                                Independent CPA verification for operational
                                security, system availability, and customer
                                confidentiality.
                            </p>
                            <span className="comp-detail">
                        ...
                        <div className="osp-compliance-card">
                            ...
                            <p>
                                Primary and failover clusters physically
                                deployed in AWS Mumbai (ap-south-1). No data
                                leaves India.
                            </p>
                            <span className="comp-detail">
                                Meets RBI &amp; DPDP Act 2023 Directives
                            </span>
                        </div>
                        ...
                        <div className="osp-compliance-card">
                            ...
                            <p>
                                Direct Tier-1 integration with Meta Cloud API
                                for high-throughput WhatsApp commerce and NDR
                                automation.
                            </p>
                            <span className="comp-detail">
                                Partner ID #849102 · Verified BSP
                            </span>
                        </div>
                        ...
                        <div className="osp-compliance-card">
                            ...
                            <p>
                                Government-approved direct pipeline for instant
                                1-click B2B/B2C IRN generation and E-Way bill
                                issuance.
                            </p>
                            <span className="comp-detail">
                                Sub-200ms IRN Minting SLA
                            </span>
                        </div>
                        ...
                        <div className="osp-compliance-card">
                            ...
                            <p>
                                ...
                                penetration testing by CERT-In empaneled
                                security auditors.
                            </p>
                            <span className="comp-detail">
                ...
                <div className="os-product-container">
                    ...
                    <div className="os-product-bottom-cta">
                        <div className="cta-left">
                            <h3>
                                Ready to upgrade your commerce operating system?
                            </h3>
                            <p>
                                Deploy BizSyncOS in 1 click. Connect your
                                stores, warehouses, and couriers in the 3-day
                                full access demo.
                            </p>
                        </div>
                ...
                <div className="os-solutions-container">
                    <div className="oss-hero-content">
                        <div className="oss-eyebrow">
                            <Workflow size={14} /> PURPOSE-BUILT ENTERPRISE
                            ARCHITECTURE
                        </div>
                        <h1 className="oss-hero-title">
                            Specialized Operating Systems for High-Velocity
                            Indian Commerce
                        </h1>
                        <p className="oss-hero-copy">
                            Generic ERPs and fragmented point tools collapse
                            under the weight of omnichannel scale. BizSyncOS
                            provides tailor-made operational workflows
                            configured for your industry's exact fulfillment
                            velocity, compliance rules, and sales channels.
                        </p>
                        <div className="oss-hero-actions">
                            ...
                            >
                                <UsersRound size={16} /> Book Architecture
                                Review
                            </button>
                        </div>
                    </div>
                    ...
                    >
                        {(
                            Object.keys(verticals) as Array<
            ...
            <section className="oss-vertical-showcase-section">
                <div className="os-solutions-container">
                    <div className="oss-showcase-header">
                        <span className="oss-vertical-badge">
                            {current.badge}
                        </span>
                        <h2>{current.title}</h2>
                            ...
                            <div className="oss-block oss-block-challenges">
                                ...
                                <div className="oss-list">
                                    {current.challenges.map(
                                        (challenge, idx) => (
                                            <div
                                                className="oss-list-item challenge"
                                                key={idx}
                                            >
                            ...
                            <div className="oss-block oss-block-solutions">
                                ...
                                <div className="oss-list">
                                    {current.solutions.map((solution, idx) => {
                                        ...
                                        return (
                                            <div
                                                className="oss-list-item solution"
                                                key={idx}
                                            >
                                                <span className="bullet-teal">
                                                    ✓
                                                </span>
                                                <p>
                                                    <strong>{title}:</strong>{' '}
                            ...
                            <div className="oss-metrics-bar">
                                {current.metrics.map((metric, idx) => (
                                    <div className="oss-metric-item" key={idx}>
                                        <div className="oss-metric-value">
                                            {metric.value}
                                        </div>
                                        <div className="oss-metric-label">
                                            {metric.label}
                                        </div>
                                        <div className="oss-metric-detail">
                                            {metric.detail}
                                        </div>
                                    </div>
                                ))}
                        ...
                        <div className="oss-console-col">
                            <div className="oss-console-card">
                                ...
                                <div className="oss-console-header">
                                    ...
                                    <div className="oss-console-title">
                                        {current.console.badge}
                                    </div>
                                ...
                                <div className="oss-console-body">
                                    <div className="oss-payload-card">
                                        <div className="oss-payload-row">
                                            ...
                                            <span className="val order-id">
                                                {current.console.orderId}
                                            </span>
                                        </div>
                                        <div className="oss-payload-row">
                                            <span className="label">
                                            ...
                                            <span className="val channel-tag">
                                    ...
                                    <div className="oss-console-steps">
                                        ...
                                        {current.console.steps.map(
                                            (step, idx) => (
                                                <div
                                                    className={`oss-step-row ${step.status}`}
                                                    key={idx}
                                                >
            ...
            <section className="oss-pipeline-section">
                <div className="os-solutions-container">
                    <div className="oss-section-intro">
                        ...
                        <h2>
                            From Multi-Channel Demand to Automated Settlement
                        </h2>
                        <p>
                            How every customer order and distributor PO flows
                            through the 4 foundational pillars of BizSyncOS
                            without human delay or inventory discrepancy.
                        </p>
                    </div>
            ...
            <section className="oss-benchmarks-section">
                <div className="os-solutions-container">
                    <div className="oss-section-intro">
                        ...
                        <h2>
                            Hard Benchmarks Across ₹850+ Cr in Managed Annual
                            GMV
                        </h2>
                        <p>
                            We measure success in reduced fulfillment friction,
                            higher inventory turnover, and cash freed from
                ...
                <div className="os-solutions-container">
                    <div className="oss-cta-banner">
                        <div className="oss-cta-content">
                            <span className="oss-cta-badge">
                                FREE ARCHITECTURAL AUDIT
                            </span>
                            <h2>
                                Bring your operational complexity to BizSyncOS.
                            </h2>
                            <p>
                                Schedule a 30-minute working session with our
                                Principal Solutions Architects to map your
                                multi-warehouse network, EDI connectors, and ERP
                                workflows into a single high-velocity operating
                                system.
                            </p>
    ...
    const flaws = [
        {
            ...
            issue: 'Legacy multi-channel OMS platforms (Unicommerce, Vinculum) query marketplaces using scheduled 15-to-30 minute cron batches.',
            consequence:
        ...
        },
        {
            ...
            issue: 'Brands typically stitch together 6 to 8 disconnected point tools: a Shopify app, a shipping aggregator, a WhatsApp CRM, a Tally connector, and an RTO tool.',
            consequence:
        ...
        },
        {
            ...
            issue: 'Traditional enterprise ERPs (SAP Business One, Microsoft Dynamics NAV) require 6 to 12 months of rollout and expensive hourly implementation consultants.',
            consequence:
                ...
                <div className="os-why-container">
                    <div className="osw-hero-content">
                        <div className="osw-eyebrow">
                            <Target size={14} /> ARCHITECTURAL BENCHMARK &
                            COMPARISON
                        </div>
                        <h1 className="osw-hero-title">
                            Why Modern Indian Commerce Leaders Are{' '}
                            <span className="osw-hero-gradient-text">
                                Replacing Legacy OMS
                            </span>
                        </h1>
                        <p className="osw-hero-copy">
                            Legacy OMS architectures built in 2012 rely on
                            fragile 30-minute cron jobs, disjointed external
                            plugins, and clunky user interfaces. BizSyncOS
                            replaces the chaos with real-time event streaming,
                            native Indian GST compliance, and an embedded AI
                            copilot.
                        </p>
                        <div className="osw-hero-actions">
                            ...
                            <button
                                ...
                                onClick={() => navigate('/contact')}
                            >
                                <UsersRound size={16} /> Schedule Architecture
                                Audit
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="osw-pillars-bar">
                        <div className="osw-pillar-item">
                            ...
                            <div className="pillar-text">
                                ...
                                <small>
                                    vs 30-minute legacy cron batch delays
                                </small>
                            </div>
                        </div>
                        <div className="osw-pillar-item">
                            ...
                            <div className="pillar-text">
                                ...
                                <small>
                                    Native 1-click IRN vs paid 3rd party plugins
                                </small>
                            </div>
                        </div>
                        <div className="osw-pillar-item">
                            ...
                            <div className="pillar-text">
                                ...
                                <small>
                                    Automated RTO defense & predictive reorders
                                </small>
                            </div>
                        </div>
                        <div className="osw-pillar-item">
                            ...
                            <div className="pillar-text">
                                ...
                                <small>
                                    One unified OS vs stacking 7 recurring SaaS
                                    bills
                                </small>
                            </div>
                        </div>
                ...
                <div className="os-why-container">
                    <div className="osw-section-intro">
                        <div className="osw-eyebrow text-amber">
                            <AlertCircle size={14} /> THE HIDDEN TAX OF LEGACY
                            SOFTWARE
                        </div>
                        <h2>
                            The 3 Architectural Traps Holding Back Growing
                            Brands
                        </h2>
                        <p>
                            When monthly orders scale from 1,000 to 25,000+,
                            outdated architectures break in predictable and
                            expensive ways.
                        </p>
                    </div>
                    ...
                    <div className="osw-flaws-grid">
                        {flaws.map((flaw, idx) => (
                            <div
                                className={`osw-flaw-card theme-${flaw.trapTheme}`}
                                key={idx}
                            >
                                <div className="osw-flaw-top-bar">
                                    <div className="osw-flaw-badge-group">
                                        <span className="osw-trap-num">
                                            {flaw.trapNumber}
                                        </span>
                                        <span className="osw-trap-label">
                                            {flaw.tag}
                                        </span>
                                    </div>
                                    <span className="osw-stat-pill">
                                        {flaw.statPill}
                                    </span>
                                </div>

                                <h3 className="osw-flaw-heading">
                                    {flaw.title}
                                </h3>
            ...
            <section className="osw-simulator-section">
                <div className="os-why-container">
                    <div className="osw-section-intro">
                        ...
                        <h2>
                            Simulate Flash Sale Concurrency: Cron Lag vs
                            Real-Time Webhooks
                        </h2>
                        <p>
                            Drag the interactive traffic volume slider to
                            simulate peak Diwali flash sales. See why legacy
                            scheduled polling queues accumulate critical delay
                            and oversell stock, while BizSyncOS locks inventory
                            in sub-15ms.
                        </p>
                    </div>
                    ...
                    <div className="osw-sim-card">
                            ...
                            <div className="osw-sim-slider-wrap">
                                <div className="osw-sim-slider-label">
                                    ...
                                    <strong className="osw-sim-traffic-value">
                                        ⚡ {simTraffic.toLocaleString()} orders
                                        / sec
                                    </strong>
                                </div>
                                <input
                        ...
                        <div className="osw-sim-grid">
                            ...
                            <div className="osw-sim-col legacy">
                                <div className="sim-col-header">
                                    <span className="sim-pill pill-red">
                                        LEGACY OMS (BATCH CRON)
                                    </span>
                                    <h4>Unicommerce / Vinculum Model</h4>
                                    <p>
                                        15-to-30 minute scheduled polling cycle
                                    </p>
                                </div>
                            ...
                            <div className="osw-sim-col bizsync">
                                <div className="sim-col-header">
                                    <span className="sim-pill pill-teal">
                                        BIZSYNCOS REAL-TIME OS
                                    </span>
                                    <h4>Atomic Redis Mutex &amp; Event Bus</h4>
                                    <p>
                                        Sub-15ms distributed webhook processing
                                    </p>
                                </div>
                                ...
                                <div className="sim-bar-group">
                                    ...
                                    <div className="sim-bar-track">
                                        <div
                                            className="sim-bar-fill fill-teal"
                                            style={{ width: '100%' }}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="sim-status-banner banner-success">
                                    <CheckCircle2 size={15} />
                                    <span>
                                        🛡️ 100% Stock Integrity: Atomic mutex
                                        locks across Shopify, Amazon, and
                                        Blinkit in &lt;15ms. Zero drops, zero
                                        cancellations.
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="osw-sim-latency-chart">
                            <div className="chart-header">
                                <h4>
                                    Real-World Architecture Latency Comparison
                                    (Lower is Better)
                                </h4>
                                <span className="chart-sub">
                                    Measured during concurrent multi-channel
                                    order spikes
                                </span>
                            </div>
                            <div className="latency-bar-list">
                                <div className="latency-bar-row">
                                    <div className="latency-name">
                                        ...
                                        <span>
                                            Sub-15ms Atomic Mutex Webhook
                                        </span>
                                    </div>
                                    <div className="latency-bar-container">
                                        <div
                                            className="latency-bar-fill bar-bizsync"
                                            style={{ width: '8%' }}
                                        >
                                    ...
                                    <div className="latency-speed-badge">
                                        ⚡ 150,000x Faster
                                    </div>
                                </div>
                                ...
                                <div className="latency-bar-row">
                                    ...
                                    <div className="latency-bar-container">
                                        <div
                                            className="latency-bar-fill bar-apps"
                                            style={{ width: '36%' }}
                                        >
                                            <span className="bar-tag">
                                    ...
                                    <div className="latency-speed-badge text-muted">
                                        ⚠️ 25,000x Slower
                                    </div>
                                </div>
                                ...
                                <div className="latency-bar-row">
                                    <div className="latency-name">
                                        <strong>
                                            Legacy OMS (Unicommerce / Vinculum)
                                        </strong>
                                        <span>
                                            Scheduled Batch Cron Polling
                                        </span>
                                    </div>
                                    <div className="latency-bar-container">
                                        <div
                                            className="latency-bar-fill bar-legacy"
                                            style={{ width: '75%' }}
                                        >
                                            <span className="bar-tag">
                                    ...
                                    <div className="latency-speed-badge text-red">
                                        🛑 150,000x Slower
                                    </div>
                                </div>
                                ...
                                <div className="latency-bar-row">
                                    <div className="latency-name">
                                        <strong>
                                            Manual Excel CSV Reconciliation
                                        </strong>
                                        <span>
                                            Operations manual spreadsheets
                                        </span>
                                    </div>
                                    <div className="latency-bar-container">
                                        <div
                                            className="latency-bar-fill bar-excel"
                                            style={{ width: '96%' }}
                                        >
                                            <span className="bar-tag">
            ...
            <section className="osw-matrix-section">
                <div className="os-why-container">
                    <div className="osw-section-intro">
                        ...
                        <h2>
                            Compare Technical Capabilities, Not Marketing
                            Slogans
                        </h2>
                        <p>
                            A detailed, factual benchmark across the four most
                            common operational models used by Indian omnichannel
                            brands today.
                        </p>
                    </div>
                    ...
                    <div className="osw-matrix-wrapper">
                        <div className="osw-matrix-table">
                            <div className="osw-matrix-header-row">
                                ...
                                <div className="col-model">
                                    Fragmented App Stack
                                </div>
                                <div className="col-model">
                                    Legacy OMS (Unicommerce / Vinculum)
                                </div>
                                <div className="col-model highlight-bizsync">
                                    <div className="bizsync-badge">
                                        RECOMMENDED
                                    </div>
                                    BizSyncOS Modern OS
                                </div>
                            ...
                            {matrixRows.map((row, idx) => (
                                <div className="osw-matrix-row" key={idx}>
                                    ...
                                    <div className="col-model text-muted">
                                        {row.spreadsheet}
                                    </div>
            ...
            <section className="osw-sidebyside-section">
                <div className="os-why-container">
                    <div className="osw-section-intro">
                        ...
                        <p>
                            See how eliminating middleware and point tools
                            transforms the flow of business data across your
                            entire company.
                        </p>
                    </div>
                    ...
                    <div className="osw-sidebyside-grid">
                        ...
                        <div className="osw-arch-card legacy">
                            <div className="arch-header">
                                <span className="arch-badge red">
                                    LEGACY COMMERCE STACK
                                </span>
                                <h3>Fragile Multi-Tool Spaghetti</h3>
                                <p>
                                    6 to 8 disconnected SaaS tools glued with
                                    fragile batch sync jobs.
                                </p>
                            </div>
                            ...
                            <div className="arch-signal-stream legacy-stream">
                                ...
                                <span className="packet-status text-red">
                                    ⚠️ Latency Congestion
                                </span>
                            </div>

                            <div className="arch-nodes-visual legacy-visual">
                                <div className="arch-node-item">
                                    <span className="dot red" /> Shopify /
                                    Webstore (Database A)
                                </div>
                                <div className="arch-arrow-down">
                                    ↓ 15-min scheduled polling
                                </div>
                                <div className="arch-node-item">
                                    <span className="dot red" /> Legacy OMS /
                                    WMS (Database B)
                                </div>
                                <div className="arch-arrow-down">
                                ...
                                <div className="arch-node-item">
                                    <span className="dot red" /> Shiprocket /
                                    Courier Aggregator (Database C)
                                </div>
                                <div className="arch-arrow-down">
                                    ↓ Daily evening Tally data entry
                                </div>
                                <div className="arch-node-item">
                                    <span className="dot red" /> Tally Prime /
                                    Accounting (Database D)
                                </div>
                            </div>
                        ...
                        <div className="osw-arch-card bizsync">
                            <div className="arch-header">
                                <span className="arch-badge teal">
                                    BIZSYNCOS UNIFIED OPERATING SYSTEM
                                </span>
                                <h3>Single Event-Driven Command Hub</h3>
                                <p>
                                    One real-time core connecting demand,
                            ...
                            <div className="arch-signal-stream bizsync-stream">
                                ...
                                <span className="packet-status text-teal">
                                    ⚡ Sub-15ms Real-Time
                                </span>
                            </div>
                                ...
                                <div className="arch-hub-box">
                                    <div className="hub-center">
                                        ...
                                        <div className="hub-sub">
                                            Redis Atomic Locks · PostgreSQL ·
                                            Event Bus
                                        </div>
                                    </div>
                                    <div className="hub-channels">
                                        <span>
                                            ⚡ Sub-15ms Webhook Ingestion
                                        </span>
                                        <span>
                                            🛡️ Unified Multi-Warehouse Stock
                                            Lock
                                        </span>
                                        <span>
                                            📦 Direct NIC GST & e-Way Bill IRN
                                        </span>
                                        <span>
                                            🤖 Native AI RTO Scoring & WhatsApp
                                            OTP
                                        </span>
                                        <span>
                                            📊 Real-Time Bi-Directional Tally
                                            Prime Sync
                                        </span>
                                    </div>
                                </div>
                ...
                <div className="os-why-container">
                    <div className="osw-tco-card">
                        <div className="osw-tco-header">
                            <div className="osw-eyebrow">
                                <CircleDollarSign size={14} /> FINANCIAL IMPACT
                                & TCO
                            </div>
                            <h2>
                                Calculate the Real Cost of Your Software Stack
                            </h2>
                            <p>
                                Stacked monthly subscriptions and point-tool
                                integration fees bleed mid-market Indian brands
                                of millions of rupees every year.
                            </p>
                        </div>
                        ...
                        <div className="osw-tco-interactive-bar-wrap">
                            <div className="tco-interactive-header">
                                <div className="tco-interactive-title">
                                    ...
                                    <strong>
                                        ⚡ {tcoOrders.toLocaleString()} monthly
                                        orders
                                    </strong>
                                </div>
                                <div className="tco-slider-group">
                                    <input
                                        ...
                                        value={tcoOrders}
                                        onChange={(e) =>
                                            setTcoOrders(Number(e.target.value))
                                        }
                            ...
                            <div className="tco-comparative-bars">
                                <div className="comp-bar-item">
                                    <div className="comp-bar-meta">
                                        <span>
                                            Fragmented 7-Tool Software Stack:
                                        </span>
                                        <strong className="text-red">
                                            ₹
                                            {computedLegacyCost.toLocaleString()}{' '}
                                            / mo
                                        </strong>
                                    </div>
                                    <div className="comp-bar-track">
                                        <div
                                            className="comp-bar-fill fill-red-stack"
                                            style={{ width: '100%' }}
                                        >
                                            <span>
                                                Stack Subscriptions +
                                ...
                                <div className="comp-bar-item">
                                    <div className="comp-bar-meta">
                                        <span>
                                            BizSyncOS All-In-One Unified OS (OMS
                                            + WMS + GST + AI):
                                        </span>
                                        <strong className="text-teal">
                                            ₹6,399 / mo
                            ...
                            <div className="tco-savings-pills-row">
                                <div className="tco-pill-card">
                                    ...
                                    <strong className="pill-metric text-teal">
                                        ₹
                                        {(
                                            (computedLegacyCost - 6399) *
                                            12
                                        ).toLocaleString()}{' '}
                                        / yr
                                    </strong>
                                    <span className="pill-sub">
                                        Direct cash margin recovered
                                    </span>
                                </div>
                                <div className="tco-pill-card">
                                    <span className="pill-title">
                                    ...
                                    <strong className="pill-metric text-blue">
                                        {Math.round((tcoOrders / 20000) * 140)}{' '}
                                        hrs / mo
                                    </strong>
                                    <span className="pill-sub">
                                        Zero manual CSV matching
                                    </span>
                                </div>
                                <div className="tco-pill-card">
                                    <span className="pill-title">
                        ...
                        <div className="osw-tco-grid">
                            ...
                            <div className="osw-tco-col legacy-tco">
                                <h4>
                                    ...
                                    {Math.round(tcoOrders / 1000)}k orders/mo)
                                </h4>
                            ...
                            <div className="osw-tco-col bizsync-tco">
                                <div className="bizsync-tco-badge">
                                    UNIFIED ALL-IN-ONE
                                </div>
                                ...
                                <div className="osw-tco-list">
                                    <div className="bizsync-included-item">
                                        ...
                                        />
                                        <span>
                                            Central OMS & Real-Time
                                            Multi-Warehouse WMS (Included)
                                        </span>
                                    </div>
                                    <div className="bizsync-included-item">
                                        <CheckCircle2
                                    ...
                                    <div className="bizsync-included-item">
                                        ...
                                        />
                                        <span>
                                            AI RTO Predictive Risk Engine &
                                            Reorder Brain (Included)
                                        </span>
                                    </div>
                                    <div className="bizsync-included-item">
                                        <CheckCircle2
                                        ...
                                        />
                                        <span>
                                            Direct NIC GST e-Invoicing & e-Way
                                            Bill IRN (Included)
                                        </span>
                                    </div>
                                    <div className="bizsync-included-item">
                                        ...
                                        />
                                        <span>
                                            Two-Way Tally Prime & Zoho Ledger
                                            Sync (Included)
                                        </span>
                                    </div>
                                    ...
                                    <div className="tco-row total-row bizsync-total">
                                        ...
                                        <strong className="cost-total teal">
                                            ₹6,399 / mo
                                        </strong>
                                    </div>
                ...
                <div className="os-why-container">
                    <div className="osw-migration-banner">
                        <div className="osw-migration-content">
                            <span className="osw-migration-badge">
                                RISK-FREE TRANSITION GUARANTEE
                            </span>
                            <h2>
                                Migrate from Unicommerce, Vinculum, or Excel in
                                48 Hours
                            </h2>
                            <p>
                                Switching operating systems shouldn't disrupt
                                your daily dispatches. Our dedicated Solutions
                                Engineers handle your entire catalog migration,
                                warehouse stock mapping, and carrier
                                configuration with zero operational downtime.
                            </p>
                            ...
                            <div className="osw-steps-row">
                                <div className="osw-mini-step">
                                    ...
                                    <p>
                                        Instant ingestion of your SKU catalog,
                                        GST HSN codes, and warehouse rules via
                                ...
                                <div className="osw-mini-step">
                                    ...
                                    <p>
                                        Run BizSyncOS side-by-side with your
                                        existing OMS for 24 hours to verify
                                ...
                                <div className="osw-mini-step">
                                    ...
                                    <p>
                                        Flip the switch with zero missed orders.
                                        Dedicated migration engineer stays on
    ...
    const plans = [
        {
            ...
            summary:
                'For small businesses, single-brand stores, and new commerce setups.',
        ...
        },
        {
            ...
            summary:
                'For fast-scaling D2C brands, omnichannel sellers, and active warehouses.',
        ...
        },
        {
            ...
            summary:
                'For multi-location operations, distributors, and high-velocity commerce.',
        ...
        },
        {
            ...
            summary:
                'For large retail chains, enterprise distributors, and custom rollouts.',
            allowance: 'Unlimited team members · Custom infrastructure',
            featured: false,
            bestFor: [
                'Large retail enterprises',
                'Custom ERP migrations',
                'High-governance orgs',
            ],
            features: [
            ...
            <section className="os-pricing-hero">
                ...
                <div className="os-pricing-container">
                    <div className="os-pricing-hero-content">
                        <p className="eyebrow blue">
                            <Sparkles size={15} /> TRANSPARENT, SCALE-TESTED
                            PRICING
                        </p>
                        <h1>
                            Predictable pricing that{' '}
                            <span>grows with your business.</span>
                        </h1>
                        <p>
                            All plans include multi-channel OMS, real-time
                            inventory, and finance reconciliation. Start with a
                            3-day full-access trial. Zero glue code, zero
                            surprise fees.
                        </p>
                        ...
                        <div className="os-pricing-hero-metrics">
                            <span>
                                <CheckCircle2 size={15} /> 3-Day Full Product
                                Trial
                            </span>
                            <span>
                            ...
                            <span>
                                <CheckCircle2 size={15} /> 100% Hosted in India
                                (AWS)
                            </span>
                        </div>
                ...
                <div className="os-pricing-container">
                    <div className="os-pricing-grid">
                        {plans.map((plan) => (
                            <div
                                key={plan.id}
                                className={`os-pricing-card ${plan.featured ? 'featured' : ''}`}
                            >
                                {plan.featured && (
                                ...
                                <div className="os-pricing-card-header">
                                    {!plan.featured && (
                                        <span className="os-pricing-badge">
                                            {plan.badge}
                                        </span>
                                    )}
                                    <h3 className="os-pricing-plan-name">
                                        {plan.name}
                                    </h3>
                                    <p className="os-pricing-summary">
                                        {plan.summary}
                                    </p>
                                    <div className="os-pricing-allowance-pill">
                                        {plan.allowance}
                                    </div>
                                </div>
                                ...
                                <div className="os-pricing-price-box">
                                    <div className="os-pricing-price-amount">
                                        ...
                                        {plan.id !== 'enterprise' && (
                                            <span className="os-pricing-period">
                                                / month
                                            </span>
                                        )}
                                    </div>
                    ...
                    <div className="os-pricing-assurances">
                        <div className="os-assurance-item">
                            ...
                            <div>
                                ...
                                <span>
                                    ISO 27001 & SOC-2 ready, tenant isolation
                                </span>
                            </div>
                        </div>
                        <div className="os-assurance-item">
                            ...
                            <div>
                                ...
                                <span>
                                    Start with OMS, expand into WMS & Finance
                                </span>
                            </div>
                        </div>
                        <div className="os-assurance-item">
                            ...
                            <div>
                                ...
                                <span>
                                    End-to-end audit trail for all business
                                    events
                                </span>
                            </div>
                        </div>
                        <div className="os-assurance-item">
                            ...
                            <div>
                                ...
                                <span>
                                    Export full catalog, orders, and ledger
                                    anytime
                                </span>
                            </div>
                        </div>
                    ...
                    <section className="os-pricing-compare-section">
                        <div className="os-pricing-compare-header">
                            ...
                            <span className="os-pricing-growth-tip">
                                <Sparkles size={14} /> <strong>Growth</strong>{' '}
                                is selected by 85% of businesses
                            </span>
                        </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" className="growth-col">
                                            Growth{' '}
                                            <span className="growth-table-badge">
                                                POPULAR
                                            </span>
                                        </th>
                        ...
                        <div className="os-pricing-addons-banner">
                            <div className="addons-title">
                                <strong>
                                    Modular Add-Ons Available on Any Plan:
                                </strong>
                            </div>
                    ...
                    <section className="os-pricing-faq-section">
                        <div className="os-faq-header">
                            ...
                            <p>
                                Got more questions? Our team is always here to
                                help.
                            </p>
                        </div>
                        ...
                        <div className="os-faq-list">
                            {faqs.map((faq, index) => {
                                ...
                                return (
                                    <div
                                        key={faq.q}
                                        className={`os-faq-item ${isOpen ? 'open' : ''}`}
                                    >
                                        <button
                                            type="button"
                    ...
                    <div className="os-pricing-bottom-cta">
                        <div className="cta-left">
                            ...
                            <p>
                                Join fast-scaling Indian brands orchestrating
                                orders, warehouse inventory, and finance on
                                BizSyncOS.
                            </p>
                        </div>
                        <div className="cta-right">
            ...
            <section className="osc-container">
                ...
                <div className="osc-header">
                    ...
                    <h1 className="osc-title">
                        ...
                        <span className="osc-gradient-text">
                            zero-downtime scale.
                        </span>
                    </h1>
                    <p className="osc-subtitle">
                        Connect directly with a Senior Solutions Architect. We
                        evaluate your order concurrency, catalog sync latency,
                        and ERP ledger handoffs to build a custom migration
                        &amp; parity blueprint in 48 hours.
                    </p>
                </div>
                    ...
                    <div className="osc-left-col">
                        <div className="osc-roadmap-card">
                            <h2 className="osc-card-heading">
                                <Sparkles size={16} /> What to expect in your
                                session
                            </h2>
                            <div className="osc-roadmap-steps">
                                <div className="osc-step-item">
                                    ...
                                    <div className="osc-step-content">
                                        ...
                                        <p>
                                            We map your channel webhook
                                            concurrency, multi-warehouse
                                            allocation rules, and logistics SLA
                                            constraints.
                                        </p>
                                    </div>
                                </div>
                                <div className="osc-step-item">
                                    ...
                                    <div className="osc-step-content">
                                        ...
                                        <p>
                                            Test your live catalog schemas, SKU
                                            bundling, and mock ERP connectors
                                            against our sub-15ms streaming
                                            backbone.
                                        </p>
                                    </div>
                                </div>
                                <div className="osc-step-item">
                                    ...
                                    <div className="osc-step-content">
                                        ...
                                        <p>
                                            Dual-write cutover schedule,
                                            automated rollback safety, and a
                                            guaranteed TCO audit saving 40–60%
                                            over legacy OMS.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="osc-trust-card">
                            <h2 className="osc-card-heading">
                                <ShieldCheck size={16} /> Enterprise Governance
                                &amp; Compliance
                            </h2>
                            <div className="osc-trust-grid">
                                ...
                                <div className="osc-trust-item">
                                    ...
                                    <div>
                                        ...
                                        <span>
                                            AWS Mumbai (ap-south-1) sovereign
                                            cloud
                                        </span>
                                    </div>
                                </div>
                                <div className="osc-trust-item">
                                    ...
                                    <div>
                                        ...
                                        <span>
                                            Sub-15ms streaming latency guarantee
                                        </span>
                                    </div>
                                </div>
                                <div className="osc-trust-item">
                                    ...
                                    <div>
                                        <strong>
                                            Direct NIC GST Invoicing
                                        </strong>
                                        <span>
                                            Automated IRN &amp; E-Way bill
                                            generation
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div className="osc-hubs-card">
                            <div className="osc-hub-row">
                                ...
                                <div className="osc-hub-detail">
                                    ...
                                    <div>
                                        <strong>
                                            Delhi NCR Operations Hub
                                        </strong>
                                        <span>
                                            DLF Cyber City, Tower B, Gurugram,
                                            HR 122002
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="osc-direct-contacts">
                                <a
                                    href="mailto:enterprise@bizsyncos.com"
                                    className="osc-contact-chip"
                                >
                                ...
                                >
                                    <MessageCircle size={14} /> VIP WhatsApp
                                    Concierge
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="osc-right-col">
                        {!isSubmitted ? (
                            ...
                            >
                                <div className="osc-form-header">
                                    <div className="osc-form-status">
                                        ...
                                        <span>
                                            Solutions Architect On-Duty · 15-Min
                                            Response
                                        </span>
                                    </div>
                                    <h2 className="osc-form-title">
                                        Request Technical Walkthrough
                                    </h2>
                                    <p className="osc-form-desc">
                                        Tell us about your order velocity and
                                        current software stack so we can assign
                                ...
                                >
                                    ...
                                    <button
                                        type="submit"
                                        className="osc-submit-btn"
                                        disabled={isSubmitting}
                                    >
                                        {isSubmitting ? (
                                            <>
                                                <span className="osc-spinner" />
                                                Routing to Senior Solutions
                                                Architect...
                                            </>
                                        ) : (
                                            <>
                                                Schedule Technical Architecture
                                    ...
                                    <div className="osc-form-footnote">
                                        <Lock size={12} />
                                        <span>
                                            NDA Protected · Direct engineer
                                            callback · Zero vendor spam
                                        </span>
                                    </div>
                                </form>
                            </motion.div>
                            ...
                            >
                                ...
                                <h2 className="osc-success-title">
                                    Consultation Request Confirmed
                                </h2>
                                <p className="osc-success-desc">
                                    Thank you, <strong>{fullName}</strong>. Your
                                    enterprise inquiry for{' '}
                                    <strong>{companyName}</strong> has been
                                    logged in our priority routing queue.
                                </p>
                ...
                <div className="saas-auth-form-panel">
                    ...
                    <div className="saas-auth-form-content">
                        ...
                        <a
                            ...
                            href={backendPath(
                                `/auth/google/redirect?intent=${kind}`,
                            )}
                        >
                            <GoogleSvg />
                            <span>
                        ...
                        <div className="saas-trial-perks-banner">
                            <div className="saas-trial-perks-title">
                                <Sparkles size={13} />
                                <span>
                                    3-Day Free Trial · Basic Plan Access
                                </span>
                            </div>
                            <div className="saas-trial-perks-list">
                                <div className="saas-trial-perk-item">
                                    <Check size={14} />
                                    <span>
                                        Full access to all Basic Plan tools &
                                        integrations
                                    </span>
                                </div>
                                <div className="saas-trial-perk-item">
                                    <Check size={14} />
                                    <span>
                                        Review inventory sync, OMS, CRM & AI
                                        risk-free
                                    </span>
                                </div>
                                <div className="saas-trial-perk-item">
                        ...
                        <div className="saas-form-footer">
                            ...
                            <p className="saas-legal-terms">
                                Protected by enterprise 256-bit encryption.
                                Authorized commercial access only.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="saas-security-footer">
                        ...
                        <span>
                            <LockKeyhole size={13} /> Role-Based Tenant
                            Isolation
                        </span>
                        <span>
                ...
                <div className="saas-auth-showcase-panel">
                    ...
                    <div className="saas-showcase-content">
                        ...
                        <h2 className="saas-showcase-title">
                            Explore everything with a{' '}
                            <em>3-day full access trial.</em>
                        </h2>
                        <p className="saas-showcase-desc">
                            Review real-time commerce sync, automated warehouse
                            inventory, finance reconciliation, and AI
                            intelligence risk-free.
                        </p>
                        ...
                        <div className="saas-modules-grid">
                            <div className="saas-module-card">
                                ...
                                <div className="saas-module-content">
                                    <strong>
                                        Omnichannel Order & Inventory Sync
                                    </strong>
                                    <p>
                                        Real-time bi-directional sync across
                                        Shopify, WooCommerce, Amazon, and
                                        WhatsApp. Zero overselling with
                                        automated multi-location stock
                                        reservation.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="saas-module-card">
                                ...
                                <div className="saas-module-content">
                                    ...
                                    <p>
                                        ...
                                        triggering, and invoice queuing with
                                        strict human-in-the-loop approval
                                        checkpoints.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="saas-module-card">
                                ...
                                <div className="saas-module-content">
                                    <strong>
                                        AI Business Brain & Decision
                                        Intelligence
                                    </strong>
                                    <p>
                                        Continuous operations monitoring,
                                        predictive inventory forecasting, lead
                                        SLA tracking, and evidence-backed
        ...
        },
        {
            ...
            svgLogo: (
                <svg viewBox="0 0 24 24" width="28" height="28">
                    ...
                    />
                    <path
                        d="M7 4V3a3 3 0 0 1 6 0v1"
                        stroke="#FFE11B"
                        strokeWidth="2"
                        fill="none"
                    />
                    <path
                        d="M10.5 8h5.5v2.5h-3v2h2.5v2.2h-2.5v3.8h-2.5V8z"
                        fill="#FFE11B"
                    />
                </svg>
            ),
        ...
        },
        {
            ...
            svgLogo: (
                <svg viewBox="0 0 24 24" width="28" height="28">
                    ...
                    />
                    <path
                        d="M12 7l4 2.5v4c0 3-2 5.5-4 6.5-2-1-4-3.5-4-6.5v-4L12 7z"
                        fill="#ffffff"
                    />
                    <path
            ...
            <section className="os-int-hero">
                ...
                <div className="os-int-container">
                    <div className="os-int-hero-content">
                        ...
                        <h1>
                            Connect your entire business stack{' '}
                            <span>in minutes.</span>
                        </h1>
                        <p>
                            Pre-built, bidirectional integrations for commerce
                            storefronts, payment gateways, courier networks,
                            accounting ERPs, and customer messaging. Zero glue
                            code required.
                        </p>
                        ...
                        <div className="os-int-controls">
                            ...
                            <div
                                className="os-int-category-pills"
                                role="tablist"
                            >
                                {categories.map((cat) => (
                                    <button
                                    ...
                                    >
                                        {cat.label}
                                        <span className="os-int-cat-count">
                                            {cat.count}
                                        </span>
                                    </button>
                                ))}
                ...
                <div className="os-int-container">
                    <div className="os-int-grid-header">
                        ...
                        <span className="os-int-live-badge">
                            <span className="pulse-dot" /> Live Bi-directional
                            Sync
                        </span>
                    </div>
                    ...
                    {filteredConnectors.length === 0 ? (
                        <div className="os-int-empty-state">
                            ...
                            <p>
                                Try searching for a different keyword or browse
                                all categories.
                            </p>
                            <button
                                type="button"
                                ...
                                >
                                    <div className="os-int-card-top">
                                        ...
                                        <div className="os-int-badge-wrap">
                                            <span className="os-int-category-tag">
                                                {item.categoryLabel}
                                            </span>
                                            <span
                                    ...
                                    <h3 className="os-int-card-title">
                                        {item.name}
                                    </h3>
                                    <p className="os-int-card-desc">
                                        {item.shortDesc}
                                    </p>
                    ...
                    <div className="os-int-dev-banner">
                        <div className="os-int-dev-info">
                            <span className="os-int-dev-tag">
                                DEVELOPER EXTENSIBILITY
                            </span>
                            <h3>
                                Need a custom ERP, carrier, or proprietary
                                database?
                            </h3>
                            <p>
                                BizSyncOS provides open REST endpoints, signed
                                JSON webhooks, and an extensible SDK. Our
                                solutions engineering team can also build and
                                certify custom connectors in 48 hours.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div className="os-int-drawer-header">
                            ...
                            <div>
                                ...
                                <p>
                                    {activeConnector.syncType} &middot; Setup
                                    time: {activeConnector.setupTime}
                                </p>
                            </div>
                        </div>

                        <div className="os-int-drawer-body">
                            <p className="os-int-drawer-overview">
                                {activeConnector.fullDesc}
                            </p>

                            <div className="os-int-flow-grid">
                                <div className="os-int-flow-card">
                                    <h4>
                                        <span className="dot teal" /> Inbound
                                        Triggers (Signals Received)
                                    </h4>
                                    <ul>
                                        {activeConnector.triggers.map(
                                            (trig) => (
                                                <li key={trig}>
                                                    <CheckCircle2 size={15} />
                                                    <span>{trig}</span>
                                ...
                                <div className="os-int-flow-card">
                                    <h4>
                                        <span className="dot blue" /> Automated
                                        Actions (Executed by BizSyncOS)
                                    </h4>
                                    <ul>
        ...
        <main className="route-page osa-page">
                ...
                <div className="osa-hero-container">
                    <div className="osa-hero-left">
                        ...
                        <h1 className="osa-title">
                            ...
                            <span className="osa-title-gradient">
                                Indian Commerce Scale
                            </span>
                        </h1>
                        <p className="osa-lead">
                            Built from the ground up for high-velocity
                            omnichannel retailers, fast-scaling D2C brands, and
                            multi-node distributors. We eliminate the chaos
                            between marketplace order surges, multi-warehouse
                            stock reservation locks, statutory GST compliance,
                            and financial truth.
                        </p>
                        ...
                        <div className="osa-topo-card">
                            <div className="osa-topo-header">
                                <div className="osa-topo-title">
                                    <span className="osa-pulse-dot" />
                                    <span>
                                        CORE ARCHITECTURE · LIVE PRODUCTION
                                    </span>
                                </div>
                            ...
                            <div className="osa-topo-nodes">
                                <div className="osa-topo-node">
                                    ...
                                    <div className="osa-node-content">
                                        <strong>
                                            Multi-Channel Ingestion Mesh
                                        </strong>
                                        <small>
                                            18.4M+ monthly webhooks synced from
                                            Shopify, Amazon SP-API, Flipkart
                                            &amp; WhatsApp in &lt;14.2ms.
                                        </small>
                                    </div>
                                </div>
                                <div className="osa-topo-node">
                                    ...
                                    <div className="osa-node-content">
                                        <strong>
                                            Distributed Inventory Lock
                                        </strong>
                                        <small>
                                            Atomic Redis reservation locks
                                            across regional fulfillment centers.
                                            0% overselling during flash sales.
                                        </small>
                                    </div>
                                </div>
                                <div className="osa-topo-node">
                                    ...
                                    <div className="osa-node-content">
                                        <strong>
                                            Direct NIC Statutory Engine
                                        </strong>
                                        <small>
                                            Direct government e-invoicing &amp;
                                            e-way bills generated in &lt;2s
                                            without middleman gateway taxes.
                                        </small>
                                    </div>
                                </div>
                                <div className="osa-topo-node">
                                    ...
                                    <div className="osa-node-content">
                                        <strong>
                                            2-Way Financial Ledger Sync
                                        </strong>
                                        <small>
                                            Bi-directional XML &amp; REST sync
                                            to Tally Prime &amp; Zoho Books with
            ...
            <section className="osa-stats-section">
                <div className="osa-stats-container">
                    <div className="osa-stat-card">
                        ...
                        <div className="osa-stat-label">
                            Annual GMV Processed
                        </div>
                        <div className="osa-stat-sub">
                            Across connected omnichannel storefronts
                        </div>
                    </div>
                    <div className="osa-stat-card">
                        ...
                        <div className="osa-stat-sub">
                            Zero overselling or dropped webhooks
                        </div>
                    </div>
                    <div className="osa-stat-card">
                        <div className="osa-stat-number">&lt; 14.2ms</div>
                        <div className="osa-stat-label">
                            Ingestion Event Latency
                        </div>
                        <div className="osa-stat-sub">
                            High-throughput reactive event bus
                        </div>
                    </div>
                    <div className="osa-stat-card">
                        ...
                        <div className="osa-stat-sub">
                            Dual-AZ resilient AWS Mumbai hosting
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="osa-mission-section">
                <div className="osa-section-header">
                    ...
                    <h2 className="osa-title">
                        Commerce moved to real-time. Software was left stuck in
                        2012.
                    </h2>
                    <p className="osa-lead">
                        For over a decade, Indian retailers have been trapped
                        between legacy desktop ERPs requiring manual batch
                        syncs, and fragmented SaaS tools that don't communicate.
                        During festive flash sales like Diwali, systems crash,
                        inventories desynchronize, and brands pay lakhs in
                        marketplace penalties. BizSyncOS was built to solve this
                        with a single, deterministic operating system.
                    </p>
                </div>
                ...
                <div className="osa-pillars-grid">
                    <div className="osa-pillar-card">
                        ...
                        <p>
                            We replaced fragile 30-minute cron batch polling
                            with a real-time reactive event mesh. When a
                            customer purchases on Shopify, inventory is
                            atomically locked across Amazon, Flipkart, Blinkit,
                            and physical stores in under 15 milliseconds.
                        </p>
                    </div>
                    <div className="osa-pillar-card">
                        ...
                        <p>
                            Built natively for the Indian regulatory landscape.
                            Direct official NIC API integration produces
                            GST-compliant IRN e-invoices, QR codes, and
                            automated e-way bills instantaneously without
                            expensive intermediary third-party wrappers.
                        </p>
                    </div>
                    <div className="osa-pillar-card">
                        ...
                        <p>
                            Accounting data should never require manual entry or
                            spreadsheet exports. BizSyncOS maintains a live
                            bi-directional ledger bridge with Tally Prime and
                            Zoho Books, recording sales vouchers, returns, and
                            payment gateway fees automatically.
                        </p>
                    </div>
                    <div className="osa-pillar-card">
                        ...
                        <p>
                            100% of customer, transactional, and catalog data
                            resides exclusively within AWS Mumbai (ap-south-1).
                            We strictly adhere to RBI data localization
                            mandates, ISO/IEC 27001:2022 standards, and India's
                            DPDP Act 2023 directives.
                        </p>
                    </div>
                </div>
                ...
                <div className="osa-hq-banner">
                    <div className="osa-hq-content">
                        ...
                        <p>
                            Designed and engineered in the heart of India's
                            Silicon Valley. Our principal solutions architects
                            and engineering teams work directly alongside
                            India's fastest-growing enterprise brands.
                        </p>
                    </div>
            ...
            <section className="osa-cta-banner">
                <div className="osa-cta-inner">
                    ...
                    <p>
                        Deploy BizSyncOS in 1 click. Connect your stores,
                        warehouses, and accounting in a 3-day full access demo.
                    </p>
...
const blogPosts: BlogPost[] = [
    ...
    },
    {
        ...
        title: 'From Cron-Job Chaos to Real-Time Streaming: Why 2012-Era Legacy OMS Collapse Under Flash Sales',
        excerpt:
    ...
    },
    {
        ...
        title: 'Automating GST IRN & E-Way Bills at Scale: Direct NIC API Integration Without Intermediaries',
        excerpt:
        ...
        <main className="route-page osb-page">
            ...
            <section className="osb-hero-section">
                <div className="osb-hero-container">
                    ...
                    >
                        Battle-tested blueprints and technical architectures
                        from engineering teams and retail leaders orchestrating
                        high-velocity omnichannel commerce across India.
                    </p>
                    ...
                    <div className="osb-featured-card">
                        <div className="osb-featured-left">
                            <span className="osb-featured-tag">
                                <Sparkles size={13} /> FEATURED PLAYBOOK ·
                                DIWALI CONCURRENCY
                            </span>
                            <h2 className="osb-featured-title">
                                How High-Growth D2C Brands Scale to 25,000
                                Orders/Day Without Overselling
                            </h2>
                            <p className="osb-featured-desc">
                                A comprehensive engineering deep-dive into
                                multi-node warehouse reservation locks,
                                distributed Redis event streaming, and sub-15ms
                                webhook ingestion pipelines under peak festive
                                shopping traffic.
                            </p>
                    ...
                    {filteredPosts.map((post) => (
                        ...
                        >
                            <div className="osb-card-top">
                                <span
                                    className={`osb-card-cat ${post.category}`}
                                >
                                    {post.categoryLabel}
                                </span>
                                <h3>{post.title}</h3>
            ...
            {activeArticle && (
                ...
                >
                    ...
                    >
                        ...
                        <span
                            className={`osb-card-cat ${activeArticle.category}`}
                        >
            ...
            <section className="osa-cta-banner">
                <div className="osa-cta-inner">
                    ...
                    <p>
                        Experience the live operating system that automates
                        orders, multi-warehouse stock locks, and GST
                        reconciliation.
                    </p>
                    <div className="osa-cta-buttons">
                        <RouteButton navigate={navigate} route="/signup">
        ...
        <main className="route-page demo-page">
            ...
            >
                <div>
                    ...
                    <p>
                        Select a sample business, follow the guided tour, then
                        create your own workspace when you are ready.
                    </p>
                </div>
                <ol>
            ...
            <section className="demo-workspace section-pad">
                ...
                >
                    ...
                    <img
                        src={stageImage}
                        alt="BizSyncOS local interactive demo workspace"
                    />
                </motion.div>
            ...
            <section className="demo-module-map section-pad">
                <div className="section-intro centered">
                    ...
                    <p>
                        Your 3-day workspace opens the real BizSyncOS backend
                        with your own team, permissions, plan limits, and
                        data—not a disconnected mockup.
                    </p>
                </div>
                ...
                <div className="demo-access-note">
                    <div>
                        ...
                        <span>
                            CRM, orders, inventory, warehouse, finance,
                            analytics, automation, AI, and integrations.
                        </span>
                    </div>
                    <RouteButton navigate={navigate} route="/signup">
                        Start live demo
...
export function PublicSite({ route, navigate }: PublicSiteProps) {
    ...
    if (route === '/why-bizsyncos')
        return <WhyBizSyncPage navigate={navigate} />;
    ...
    if (route === '/login')
        return <AuthPage kind="login" navigate={navigate} />;
    if (route === '/signup')
        return <AuthPage kind="signup" navigate={navigate} />;
