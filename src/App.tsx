...
const isPublicRoute = (value: string): value is Route =>
    publicRoutes.includes(value as Route);
        ...
        <header className="site-header">
            {announcementOpen ? (
                <div className="announcement">
                    <span>
                        <Sparkles size={14} /> New: AI Business Assistant is now
                        live. Smarter insights. Better decisions.
                    </span>
            ...
            <div className="nav-shell">
                ...
                <nav className="desktop-nav" aria-label="Main navigation">
                    ...
                    <button
                        ...
                        aria-current={
                            isActive('/solutions') ? 'page' : undefined
                        }
                    >
                        Solutions
                    </button>
                    <button
                        ...
                        aria-current={
                            isActive('/integrations') ? 'page' : undefined
                        }
                    >
                        Integrations
                    </button>
                    <button
                        ...
                        aria-current={
                            isActive('/why-bizsyncos') ? 'page' : undefined
                        }
                    >
                        Why BizSyncOS
                    </button>
                            ...
                            >
                                ...
                                <button onClick={() => go('/docs')}>
                                    ...
                                    <span>
                                        Documentation
                                        <small>
                                            Platform setup, catalog ingestion
                                            &amp; guides.
                                        </small>
                                    </span>
                                </button>
                                ...
                                <button onClick={() => go('/blog')}>
                                    ...
                                    <span>
                                        ...
                                        <small>
                                            Omnichannel case studies &amp; scale
                                            strategies.
                                        </small>
                                    </span>
                                </button>
            ...
            {mobileOpen ? (
                <div className="mobile-nav">
                    ...
                    <button
                        className={isActive('/docs') ? 'is-active' : ''}
                        onClick={() => go('/docs')}
                    >
                        Documentation
                    </button>
                    <button
                        className={isActive('/blog') ? 'is-active' : ''}
                        onClick={() => go('/blog')}
                    >
                        Insights
                    </button>
                    <button
                        className={
                            isActive('/why-bizsyncos') ? 'is-active' : ''
                        }
                        onClick={() => go('/why-bizsyncos')}
                    >
                        Why BizSyncOS
            ...
            <AnimatedSection>
                ...
                <div className="trust-bar-logos">
                    {logos.map((logo) => (
                        <span
                            key={logo.initial}
                            className="trust-logo hover-lift"
                        >
    ...
    return (
        <section className="testimonials-section">
            ...
            >
                ...
                <p>
                    The platform is designed to replace fragmented operational
                    work with accountable workflows and trusted decisions.
                </p>
            </AnimatedSection>
    ...
    return (
        <section className="health-section section-pad">
            <AnimatedSection className="section-intro centered">
                ...
                <h2>
                    One score that explains where the business needs attention.
                </h2>
                <p>
                    BizSyncOS combines authorized operational signals into an
                    explainable health view. This visual is an illustrative
                    demo, not a live customer score.
                </p>
            </AnimatedSection>
...
export function RoiCalculator() {
    ...
    const hoursSaved = Math.round(
        (orders / 125) * 1.2 + employees * 2 + warehouses * 4,
    );
    ...
    return (
        <section className="roi-section section-pad">
            <div className="roi-copy">
                ...
                <p>
                    Use your own inputs to explore a directional estimate.
                    Results are transparent estimates, not a promise of savings
                    or revenue.
                </p>
            </div>
            <div className="roi-calculator">
                ...
                <div className="roi-results">
                    ...
                    <article>
                        ...
                        <strong>
                            ₹{consolidation.toLocaleString('en-IN')}
                        </strong>
    ...
    return (
        ...
        >
            ...
            {ecosystemNodes.map((node) => {
                ...
                return (
                    <article
                        className={`ecosystem-node node-${node.id}`}
                        key={node.id}
                    >
                        <span>
                            <Icon size={17} />
...
function HeroProductStage() {
    ...
    return (
        ...
        >
            ...
            <span
                className="hero-product-halo hero-product-halo-secondary"
                aria-hidden="true"
            />
            <motion.div
            ...
            >
                ...
                <div className="hero-console-body">
                    ...
                    <p>
                        <BrainCircuit size={14} /> AI has prepared the next
                        approved action.
                    </p>
                </div>
                ...
                <div className="hero-product-insight-copy">
                    ...
                    <p>
                        Grounded in your live sales, stock, and collections
                        data.
                    </p>
                </div>
        ...
        <main>
            <section className="hero hero-product-hero section-grid">
                ...
                >
                    ...
                    >
                        <Sparkles size={15} /> AI-POWERED BUSINESS OPERATING
                        SYSTEM
                    </motion.p>
                    <motion.h1
                        initial={
                    ...
                    >
                        ...
                        marketing, and AI automation from one place. Built for
                        modern businesses that want to scale.
                    </motion.p>
                    <motion.div
                    ...
                    >
                        ...
                        <ButtonLink
                            ...
                            variant="secondary"
                        >
                            <Play size={16} fill="currentColor" /> Watch 2-min
                            product tour
                        </ButtonLink>
                    </motion.div>
                    <motion.p
            ...
            <section id="integrations" className="integration-strip">
                <AnimatedSection>
                    ...
                    <small>
                        Connector names describe supported or planned workflows;
                        they do not claim a partnership or endorsement.
                    </small>
                </AnimatedSection>
            </section>
            ...
            <section className="problem section-pad">
                <AnimatedSection className="section-intro narrow">
                    ...
                    <h2>
                        Your business. Your hustle. These should not slow you
                        down.
                    </h2>
                    <p>
                        When every team uses a different tool, the business
                        loses time, trust in the numbers, and the ability to act
                        early.
                    </p>
                </AnimatedSection>
                ...
                <p className="problem-closing">
                    BizSyncOS connects your entire business into one intelligent
                    operating system.
                </p>
            </section>
            ...
            <section id="solutions" className="system section-pad">
                <AnimatedSection className="section-intro centered">
                    ...
                    <h2>
                        One operating system. Every team, tool, and decision
                        connected.
                    </h2>
                    <p>
                        BizSyncOS sits at the center: every store, team, module,
                        signal, and approved action shares the same business
                        context.
                    </p>
                </AnimatedSection>
                <ConnectedEcosystem />
                <p className="ecosystem-note">
                    A customer order can update CRM, reserve inventory, create
                    warehouse work, record finance events, trigger automation,
                    and give AI the evidence to recommend the next step.
                </p>
            </section>
            ...
            <section id="product" className="features section-pad">
                <AnimatedSection className="section-intro">
                    ...
                    <h2>
                        The all-in-one operating system for modern businesses.
                    </h2>
                    <p>
                        Start with the workflows your team needs today, then
            ...
            >
                <AnimatedSection className="section-intro centered">
                    ...
                    <p>
                        Move across the operating system and see the context
                        every team needs to act with confidence.
                    </p>
                </AnimatedSection>
                    ...
                    <div className={`showcase-panel view-${activeProduct.id}`}>
                        <div className="showcase-side">
                            <span className="panel-badge">
                                BIZSYNCOS / {activeProduct.label.toUpperCase()}
                            </span>
                            <h3>
                        ...
                        <div className="showcase-screen">
                            ...
                            <div className="screen-chart">
                                <div className="screen-chart-head">
                                    <span>
                                        {activeProduct.label} performance
                                    </span>
            ...
            <section className="intelligence-suite section-pad">
                <section id="ai" className="ai-section">
                    <div
                        className="ai-orb orb-one float-orb"
                    ...
                    <div className="ai-copy">
                        ...
                        <p>
                            BizSync AI analyses authorized operations,
                            customers, inventory, revenue, and performance to
                            surface risks and recommend the next best action.
                        </p>
                        <ul>
                            <li>
                            ...
                            <li>
                                <Check /> Owner approval before high-impact
                                action
                            </li>
                        </ul>
                        <ButtonLink
                    ...
                    <div className="ai-conversation">
                        ...
                        <div className="chat-answer">
                            ...
                            <p>
                                Sales dropped because Product A was out of
                                stock, COD failures increased, and repeat
                                purchases declined. Verified evidence is ready
                                for review.
                            </p>
                            <div className="recommendations">
                                ...
                                <span>
                                    <CheckCircle2 /> Launch repeat-purchase
                                    campaign
                                </span>
                            </div>
                ...
                <section id="automation" className="automation">
                    <AnimatedSection className="section-intro">
                        ...
                        <p>
                            Compose reliable business workflows with event
                            triggers, conditions, approvals, waits, and complete
                            execution history.
                        </p>
                    </AnimatedSection>
                    <div className="automation-layout">
                        ...
                        <div className="automation-list">
                            ...
                            <p>
                                High-impact actions can require explicit policy
                                checks and authorized human approval.
                            </p>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <Check /> Nested conditions and typed
                                    variables
                                </li>
                                <li>
                                    <Check /> Retries, waits, and execution
                                    history
                                </li>
                                <li>
                                    <Check /> Templates to get teams started
                                    fast
                                </li>
                            </ul>
                            <ButtonLink
            ...
            <section className="recovery section-pad">
                <AnimatedSection className="section-intro centered">
                    ...
                    <p>
                        Use a connected view of payments, stock, customers,
                        orders, and campaigns to find the next best recovery
                        opportunity.
                    </p>
                </AnimatedSection>
                ...
                <p className="demo-note">
                    Opportunity values appear only inside sample workspaces or
                    when calculated from your authorized business data.
                </p>
            </section>
            ...
            <section className="industries section-pad" aria-hidden="true">
                <AnimatedSection className="section-intro">
                    ...
                    <p>
                        Connect the complete journey from customer to payment,
                        without forcing every business into the same workflow.
                    </p>
                </AnimatedSection>
                <AnimatedStagger className="industry-grid">
                    {[
                        ...
                        <article key={industry} className="hover-lift">
                            ...
                            <h3>{industry}</h3>
                            <p>
                                Manage the complete business lifecycle with a
            ...
            <section className="comparison section-pad" aria-hidden="true">
                <AnimatedSection className="section-intro centered">
                    ...
                    <h2>
                        Replace disconnected work with a connected operating
                        model.
                    </h2>
                </AnimatedSection>
            ...
            <section className="pricing-preview section-pad">
                <div className="pricing-intro">
                    <p className="eyebrow light">
                        <CircleDollarSign size={15} /> PRICING THAT SCALES WITH
                        YOU
                    </p>
                    <h2>Start simple. Scale without changing platforms.</h2>
                    <p>
                        BizSyncOS plans are designed around the people,
                        operational depth, and AI usage your business actually
                        needs.
                    </p>
                    <ButtonLink
            ...
            <section className="security section-pad" aria-hidden="true">
                <div className="security-copy">
                    ...
                    <p>
                        BizSyncOS applies product-level controls so teams can
                        work quickly without losing governance or
                        accountability.
                    </p>
                    <ButtonLink
                        onClick={() => navigate('/product')}
            ...
            <section className="faq-enhanced section-pad">
                ...
                >
                    ...
                    <h2>
                        Everything you need to know before you connect your
                        business.
                    </h2>
                </AnimatedSection>
            ...
            <section className="final-cta">
                ...
                <p>
                    Run operations, grow revenue, automate work, and make
                    smarter decisions from one intelligent platform.
                </p>
                <div>
                    <ButtonLink onClick={() => navigate('/demo')}>
                        Try live demo
            ...
            <div className="footer-inner-shell">
                ...
                <div className="footer-partners-bar-wrap">
                    <div className="footer-partners-header">
                        ...
                        <span className="footer-partners-title">
                ...
                <div className="footer-nav-grid">
                    ...
                    <div className="footer-brand-col">
                        ...
                        <p className="footer-brand-tagline">
                            The unified real-time operating system for modern
                            high-velocity D2C, omnichannel retail, and
                        ...
                        <div className="footer-trust-badges">
                            <span className="footer-badge-item">
                                <ShieldCheck
                                    size={14}
                                    className="badge-icon-shield"
                                />{' '}
                                ISO 27001 Certified &amp; SOC-2 Type II
                            </span>
                            <span className="footer-badge-item">
                                <Cloud size={14} className="badge-icon-cloud" />{' '}
                                100% Hosted in India (AWS Mumbai)
                            </span>
                            <span className="footer-badge-item">
                                <CheckCircle2
                                    size={14}
                                    className="badge-icon-check"
                                />{' '}
                                Official Meta BSP &amp; Razorpay Partner
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="footer-col-links">
                            <li>
                                <button
                                    type="button"
                                    onClick={() => navigate('/why-bizsyncos')}
                                >
                    ...
                    <div>
                        ...
                        <ul className="footer-col-links">
                            ...
                            <li>
                                <a href="mailto:support@bizsyncos.com">
                                    support@bizsyncos.com
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="footer-bottom-inner">
                    <div className="footer-bottom-left">
                        <span className="footer-copyright">
                            &copy; 2026 BizSyncOS Technologies Pvt. Ltd. All
                            rights reserved.
                        </span>
                        <span className="footer-region">
                            <span
                                className="footer-flag-badge"
                                aria-hidden="true"
                            >
                                <svg
                                    width="16"
                            ...
                            Engineered with pride in Bengaluru, India for global
                            commerce.
                        </span>
                    </div>
                    ...
                    <div className="footer-bottom-center">
                        <span className="footer-status-pill">
                            <span className="footer-status-dot" /> 99.99%
                            Operational SLA
                        </span>
                    </div>
